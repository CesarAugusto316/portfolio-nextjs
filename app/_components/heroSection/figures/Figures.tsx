  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.pentagon}>
        <svg className={styles.animatorContainer} width="23rem" height="23.4rem" stroke={'var(--base-200)'} strokeWidth="1" fill={'var(--base-50)'} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
