  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.pentagon}>
        <svg className={styles.animatorContainer} width="23rem" height="23.4rem" stroke={'var(--secondary-50)'} strokeWidth="0.4" fill={'white'} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
